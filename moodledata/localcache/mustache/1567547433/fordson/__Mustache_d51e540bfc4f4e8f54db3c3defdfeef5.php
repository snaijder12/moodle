...
class __Mustache_d51e540bfc4f4e8f54db3c3defdfeef5 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionB941695791ee401ad6f715185f85bba7($context, $indent, $value);
...
';
    ...
    private function sectionB941695791ee401ad6f715185f85bba7(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '
';
                $buffer .= $indent . '<div id="fordsoncarousel" class="carousel slide d-none d-sm-block" data-ride="carousel">
';
                $buffer .= $indent . '
';
